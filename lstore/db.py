...
class Database():
    ...
    # this will call a function from table.py that will expedite the 
    # process of acquiring values from a table from the database.
...
# Still indecisive on release_lock and release_locks both being used together
# Will wait til after testing to determine if we keep them.
